...
class ModuleBuildTests(unittest.TestCase):
    def test_compatibility_build_links_chan_svistok_with_hidden_bridges(self) -> None:
        ...
        self.assertEqual(35, report["objects"])
        self.assertEqual(31, report["slices"])
        self.assertEqual(16, report["baseline_slices"])
        self.assertEqual(15, report["overlay_compositions"])
        self.assertEqual(83, report["bridges"])
        self.assertEqual(14, len(report["hidden_baseline_entries"]))
